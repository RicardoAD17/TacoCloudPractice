...
public class OrderTacoApiTest {
    ...
    public void zipTestValuePatch(){
        ...
        // ¡Solución! Usar instancia real, NO un mock. Así el JSON no saldrá vacío.
        ...
        // ¡Solución! Quitamos aserciones de zip y state porque el DTO OrderResponse no los expone.
    }
    ...
    @Test void putCorrecto(){
        ...
        // ¡Solución! Usar instancia real, NO un mock.
        OrderMapper orderMapper = new OrderMapper();
        ...
        .jsonPath("$.id").isEqualTo("123") 
        .jsonPath("$.deliveryName").isEqualTo("PUTPrueba1");
        // ¡Solución! Quitamos street, state, zip porque no están en OrderResponse.
    }
